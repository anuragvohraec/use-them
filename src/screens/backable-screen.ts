                ...
                <lay-them in="row" ma="flex-start" ca="stretch">
                    <div @click=${()=>{
                        ...
                        <lay-them ma="center" ca="center">
                            <div style="padding: 0px 10px;"><iron-icon icon="chevron-left" style="fill: white;"></iron-icon></div>
                        </lay-them>
                    </div>
                    <div style="flex:1;">
...
export class BackableScreen extends NoBlocWidgetBuilder{
    ...
    builder(state: number): TemplateResult {
        return html`<lay-them>
            <title-bar-with-back-button title=${this.title} use=${this.getAttribute("use")!}></title-bar-with-back-button>
